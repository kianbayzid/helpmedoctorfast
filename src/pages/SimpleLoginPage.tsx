...
import { Lock, Eye, EyeOff, Stethoscope, AlertCircle, Info } from 'lucide-react';
...
const SimpleLoginPage: React.FC = () => {
  ...
  const handleQuickLogin = async (role: 'doctor' | 'patient') => {
      ...
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          ...
          <p className="mt-2 text-gray-600">
            Welcome to Help Me Doctor Fast
          </p>
        </div>
            ...
            {showCredentials && (
              <div className="mt-4 bg-gray-50 rounded-lg p-4 text-sm">
                <div className="space-y-3">
                  <div>
                    <p className="font-medium text-gray-900">Doctor Login:</p>
                    <p className="text-gray-600">Email: {defaultCredentials.doctor.email}</p>
                    <p className="text-gray-600">Password: {defaultCredentials.doctor.password}</p>
                  </div>
                  <div>
                    <p className="font-medium text-gray-900">Patient Login:</p>
                    <p className="text-gray-600">Email: {defaultCredentials.patient.email}</p>
                    <p className="text-gray-600">Password: {defaultCredentials.patient.password}</p>
                  </div>
                </div>
              </div>
            )}
